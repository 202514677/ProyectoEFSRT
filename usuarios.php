...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['registrar_usuario'])) {
    ...
    $stmtValidar->execute([$username]);

    if ($stmtValidar->fetchColumn() == 0) {

        $stmt = $pdo->prepare(
            "INSERT INTO usuarios
            (username, password, nombre, rol, estado)
            VALUES (?, ?, ?, ?, 1)"
        );
...
if (isset($_GET['cambiar_estado']) && isset($_GET['id'])) {
    ...
    $id_u = (int)$_GET['id'];
    $nuevo_estado = (int)$_GET['cambiar_estado'];
    ...
    if ($stmt->execute([$nuevo_estado, $id_u])) {
        ...
        registrarLog(
            ...
            'MODIFICAR_ESTADO',
            'usuarios',
            "Cambio de estado del usuario ID: $id_u a $nuevo_estado"
        );
    }
...
<div class="main-content">
    ...
    <form action="" method="POST" class="filter-box" style="background:#fcfcfc;">
        ...
        <button
            type="submit"
            class="btn"
            style="width:auto; height:42px; align-self:flex-end;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a
                            ...
                            style="color:#3498db; font-weight:bold; margin-right:10px;">
                        ...
                        <?php if($u['estado'] == 1): ?>
                            ...
                            <a
                                ...
                                class="btn-delete"
                                style="color:#e67e22; font-weight:bold; margin-right:10px;">
                        ...
                        <?php else: ?>
                            ...
                            <a
                                ...
                                style="color:#2bc155; font-weight:bold; margin-right:10px;">
